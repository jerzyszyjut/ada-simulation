...
procedure Simulation is
   ...
   Product_Name  : constant array (Product_Type) of String (1 .. 11)  :=
     ("CPU        ", "GPU        ", "RAMChip    ", "PowerSupply", "Cooling    ", "Motherboard", "HDD        ", "SSD        ", "Case       ");
   Computer_Name : constant array (Computer_Type) of String (1 .. 9) :=
    ...
    begin
        ...
        loop
            delay Duration
               (Random_Production.Random (G)); --  simulate production
    ...
    task body Client is
        ...
        Client_Name   :
           constant array (1 .. Number_Of_Clients) of String (1 .. 7) :=("Client1", "Client2");
    begin
        accept Start
           (Client_Number : in Client_Type; Consumption_Time : in Integer)
        do
    ...
    task body Shop is
        ...
        begin
            ...
            if Integer'Max (0, Max_Computer_Content (Product) - Storage (Product)) > 0 then
    ...
    begin
        ...
        loop
            ...
            Storage_Contents;
            accept Deliver (Computer : in Computer_Type; Number : out Integer)
            do
                if Can_Deliver (Computer) then
                    Put_Line
                       ("Delivered computer " & Computer_Name (Computer) &
                        " number " &
